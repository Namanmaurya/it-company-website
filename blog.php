                            ...
                            <div class="col-lg-12 mb-5">
                                <div class="single-blog-item">
                                    ...
                                    <div class="blog-item-content mt-4">
                                        <h2 class="mt-3 mb-3 text-md"><a href="blog-single.html">Improve design with
                                                typography?</a></h2>
                                        ...
                                        <p class="lead mb-4">Non illo quas blanditiis repellendus laboriosam minima
                                            animi. Consectetur accusantium pariatur repudiandae!</p>
                                        ...
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Possimus natus,
                                            ...
                                            necessitatibus distinctio voluptates, iusto qui. Laboriosam autem, nam
                                            voluptate in beatae.</p>
                                        ...
                                        <p class="lead mb-4 font-weight-normal text-black">The same is true as we
                                            experience the emotional sensation of stress from our first instances of
                                            social rejection ridicule. We quickly learn to fear and thus automatically.
                                        </p>
                                        ...
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iste, rerum beatae
                                            ...
                                            itaque quidem, voluptatem autem eos animi laborum iusto expedita sapiente.
                                        </p>
                            ...
                            <div class="col-lg-12 mb-5">
                                <div class="posts-nav bg-gray p-5 d-lg-flex d-md-flex justify-content-between ">
                                    <div class="posts-prev-item mb-4 mb-lg-0">
                                        <span class="nav-posts-desc">- Previous Post</span>
                                        <h6 class="nav-posts-title mt-1">
                                            <a href="#">Donec consectetuer ligula <br>vulputate sem tristique.</a>
                                        </h6>
                                    </div>
                                    <div class="border"></div>

                                    <div class="posts-next-item pt-4 pt-lg-0">
                                        <span class="nav-posts-desc text-lg-right text-md-right d-block">- Next
                                            Post</span>
                                        <h6 class="nav-posts-title mt-1">
                                            <a href="#">Ut aliquam sollicitudin leo.</a>
                                        </h6>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="sidebar-wrap pl-lg-4 mt-5 mt-lg-0">
                            ...
                            <div class="sidebar-widget mb-3">
                                <a href="#"><img src="images/blog/adv.jpg" alt="" class="img-fluid"></a>
                            </div>
