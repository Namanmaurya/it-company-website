...
<head>
	...
	<title>Python It Services</title>
	<!-- Bootstrap CSS -->
				...
				<div class="row align-items-center">
					<div class="col-lg-6">
						<div class="heading feature-list">
							...
							<a href="services.php" class="btn btn-main">All Services<i
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-2 col-md-3 col-sm-4">
						<div class="award-img-block mb-4 mb-lg-0" data-aos="zoom-in">
							<div class="award-img">
					...
					<div class="col-lg-2 col-md-3 col-sm-4">
						<div class="award-img-block mb-4 mb-lg-0" data-aos="zoom-in" data-aos-delay="100">
							<div class="award-img">
					...
					<div class="col-lg-2 col-md-3 col-sm-4">
						<div class="award-img-block mb-4 mb-lg-0" data-aos="zoom-in" data-aos-delay="200">
							<div class="award-img">
					...
					<div class="col-lg-2 col-md-3 col-sm-4">
						<div class="award-img-block mb-4 mb-lg-0" data-aos="zoom-in" data-aos-delay="300">
							<div class="award-img">
					...
					<div class="col-lg-2 col-md-3 col-sm-4">
						<div class="award-img-block mb-4 mb-lg-0" data-aos="zoom-in" data-aos-delay="400">
							<div class="award-img">
					...
					<div class="col-lg-2 col-md-3 col-sm-4">
						<div class="award-img-block" data-aos="zoom-in" data-aos-delay="500">
							<div class="award-img">
