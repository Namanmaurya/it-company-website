                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="block text-center">
                            ...
                            <h1 class="text-capitalize text-lg theme_headerh1">Our Group</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="project_detail_main_img">
                            <img src="images\service\our_group_img.png" alt="project_image">
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="project_detailed_exp">
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="project_detailed_exp_logo">
                                        <img src="images\service\skill_swao_logo (4).png" alt="project_logo">
                                    </div>
                                </div>
                                <div class="col-md-9">
                                    <div class="project_detailed_exp_text">
                                        <p class="theme_pra_text">
                                           Our Group is a mobile app built to make group communication and
                                            collaboration easier, smarter, and more organized. Whether you're planning
                                            events, managing a team, coordinating with classmates, or simply staying in
                                            touch with friends or family, Our Group keeps everyone connected in one
                                            place. Create multiple groups, share messages, photos, tasks, and polls, and
                                            stay updated with real-time notifications. With a clean interface and
                                            powerful features, Our Group helps reduce clutter and streamline
                                            conversations, so your group stays focused and engaged. Stay connected, stay
                                            organized—Our Group is your all-in-one hub for group interaction and
                                            coordination.
                                        </p>
                                    </div>
                                </div>
