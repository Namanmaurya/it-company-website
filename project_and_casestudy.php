        ...
        <section id="intro">
            <div class="container-fluid">
                <div class="section-title">
                    <h2>Projects and Case Study</h2>
                    <p>Reviewing our project and case study will help you understand the features, goals, and results,
                        making it easier to identify what meets your needs.</p>
                </div>
