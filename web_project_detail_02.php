                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="project_detail_main_img">
                            <img src="images\service\project_noida_03.png" alt="project_image">
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="project_detailed_exp_logo">
                                        <img src="images\service\gnk_logo.png" alt="project_logo">
                                    </div>
                                </div>

                                <div class="col-md-9">
                                    <div class="project_detailed_exp_text">
                                        <p class="theme_pra_text">GNK Solution Pvt. Ltd. is a leading technology company that provides innovative solutions to businesses and organizations around the world. The company has been providing technology solutions to businesses of all sizes for over a decade.</p>
                                    </div>
                                </div>
                            </div>
